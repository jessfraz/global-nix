{
  ...
  version = "1.46.0";
  tag = "V${version}";
  srcHash = "sha256-rIoVXEz4K0RFb1ir1gRCyDw5euNwQvLS0GwBsJhuApE=";
  binariesHashArm64 = "sha256-j/Q+Q+U8vlowjdvVdKXaq/3a0hyWb1OQdBv1BD12p68=";
  binariesHashAmd64 = "sha256-WJaYgBQdGZHYC2+F1PJNQvT8oQMC+mj/ublXBka4nyk=";

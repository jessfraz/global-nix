{
  ...
  version = "1.43.0";
  tag = "V${version}";
  srcHash = "sha256-xWqPeM1A9YV/kPJwTa8AgasLqkSNkNquFeUG2gzfjyg=";
  binariesHashArm64 = "sha256-oVivy/ApwK9/GNsgnXsaDargguBsFJYYehlvCJyQano=";
  binariesHashAmd64 = "sha256-gOmVMaI+Zu96hQaoL8tmW7Do4X8eGm1OiZkbyuMagug=";

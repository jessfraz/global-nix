{
  ...
  version = "1.28.0";
  tag = "V${version}";
  srcHash = "sha256-K2+4p1t8MTuAYldPLL2W5VUOff+NNy5hqfrkv1YKYxI=";
  binariesHashArm64 = "sha256-/spZh4fDpdMnVGz8v/WDJiUgA1WCNYFcaWVKgeCgcAk=";
  binariesHashAmd64 = "sha256-+qJOCyyVXIkJ39QdUebQ+B0HWgRTeVGbCOLbsuQ5vAI=";

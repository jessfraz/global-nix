{
  ...
  version = "1.38.1";
  tag = "V${version}";
  srcHash = "sha256-HL56RBJbzhelQeW/RwTqbvJPHQGzRLyCPjWVCUQGyIQ=";
  binariesHashArm64 = "sha256-AeX1/H7vDMDbAnEWmU7q9Re/z1UdSspQJGCfWSpTt0s=";
  binariesHashAmd64 = "sha256-paZPX8dNY3KFFqiHvQ/AsXDhgZy8DGvPuFBx84s2Pb4=";

{
  ...
  version = "1.33.0";
  tag = "V${version}";
  srcHash = "sha256-IQcnwpwzabRLznqSin73OI7G7Jw1OjXX2JBIPFkquas=";
  binariesHashArm64 = "sha256-Tudl3tzxKE9BKkL07mvmBaJZp+abaYsF2MvVm63OxlM=";
  binariesHashAmd64 = "sha256-if5RpAH51dIvttsE2n7hnSiHX7AAYYPQq+6Gl6/QY7Q=";

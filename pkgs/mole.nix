{
  ...
  version = "1.27.0";
  tag = "V${version}";
  srcHash = "sha256-7a5oQfJJIESjit+gl7FrbkT5wptxBhhWuTLCpULlQ6w=";
  binariesHashArm64 = "sha256-u/NcuWi5DjAKp2gSSxMH+dT/VI9724Ojqk4cWA2+wZg=";
  binariesHashAmd64 = "sha256-t/nR2Kr/d9oO536bJq2jeoS9o69ks2wyg16TkGQRx+o=";

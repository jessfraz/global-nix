{
  ...
  version = "1.49.2";
  tag = "V${version}";
  srcHash = "sha256-F9uPcWK5C8Ca7bNVIEY2uUo1Me0lFnP2N14UEMUk17M=";
  binariesHashArm64 = "sha256-tJZ9fFoOMLahtDaKTOmS+erejm3+/7ZZsmf3GyMW4Kg=";
  binariesHashAmd64 = "sha256-woYlETNULmUo2eBfR24z/AAh/lsxMJdBxEpjTVLP1to=";
